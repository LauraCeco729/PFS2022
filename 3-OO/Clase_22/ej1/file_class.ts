...
export default class ParsearArchivo {
    private separadorFila: string;
    private separadorColumna: string;
    private info: string[][] = [];                     //datos parseados por filas y por columnas info[fila][columna]//

    constructor(separadorFila: string, separadorColumna: string) {
     ...
     */
    public saveFile(fileName: string, info: string[][]) {
        let data: string = "";
     ...
     */
    public getCantidadColumnas(index: number): number {
     ...
     */
    public getFila(index: number): string[] {
